...
<ul class="shortcuts">
  ...
  <li><?php echo $this->Html->link('Timeline', '/teams/view/' . $team['Team']['slug'] . '/layout:timeline/end:2017-06-01', array('class'=> (($layout=='timeline') ? 'active' : '') )); ?></li>
</ul>
<?php
//_debug($events);
switch($layout) {
  case 'list':
    ...
    break; 
  case 'timeline':
    echo $this->element('Events/events_timeline',array('events'=>$events, 'team_id'=>$team['Team']['id']));
    break; 
  default:
